...
long beepBeepTimer=0; //when the backing up begins
int beepBeeps=0; //counts how many beeps have happened
long wallSpinLeftTimer=0; //when the spin left at intervals begins
int numberOfSpinLefts=0; //count how many spin lefts have happened
long wallSpinRightTimer=0; //when the spin right at intervals begins
int numberOfSpinRights=0; //count how many spin rights have happened
...
unsigned long servoDumpInterval = 1000; //Time it takes to dump
unsigned long servoLiftInterval = 1000; //Time it takes to lift
